 ...
 * ```
 */
declare function useDialogState<T>(selector: (state: DialogState) => T): T;
/**
 ...
 * ```
 */
declare function DialogProvider(props: DialogProviderProps): ReactNode;
//#endregion
export { type AlertContext, AlertOptions, type ChoiceContext, ChoiceOptions, type ConfirmContext, ConfirmOptions, ContentFactory, DialogActions, type DialogContainerOptions, type DialogId, DialogProvider, DialogProviderProps, type DialogSize, type DialogState, type DialogStyle, type DialogTheme, type PromptContext, PromptOptions, ShowOptions, themes, useDialog, useDialogKeyboard, useDialogState };